import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as t,a as n,b as s,d,e,r as o}from"./app.48f1d0d6.js";const r="/assets/mysql-explain.b1e580b8.png",c={},p=e(`<h2 id="基本常用操作" tabindex="-1"><a class="header-anchor" href="#基本常用操作" aria-hidden="true">#</a> 基本常用操作</h2><h3 id="创建数据库" tabindex="-1"><a class="header-anchor" href="#创建数据库" aria-hidden="true">#</a> 创建数据库</h3><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--创建数据库，并设定编码集为utf8</span>
