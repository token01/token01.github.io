...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,34),h={href:"https://github.com/CarpenterLee/JCFInternals",target:"_blank",rel:"noopener noreferrer"},f=e("hr",null,null,-1);function x(_,k){const n=o("ExternalLinkIcon");return l(),r("div",null,[t,u,e("p",null,[i("前面以 Java "),e("a",v,[i("ArrayDeque"),d(n)]),i("为例讲解了"),m,i("和"),b,i("，其实还有一种特殊的队列叫做"),p,i("，即优先队列。")]),g,e("blockquote",null,[e("p",null,[i("参考链接："),e("a",h,[i("https://github.com/CarpenterLee/JCFInternals"),d(n)]),i("，作者：李豪，整理：musk")])]),f])}const Q=a(c,[["render",x],["__file","PriorityQueue.html.vue"]]);export{Q as default};
