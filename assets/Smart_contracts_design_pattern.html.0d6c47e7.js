import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.8c636bb6.js";const e="/assets/contract-oracle.d92a3039.png",p={},c=t(`<h2 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式" aria-hidden="true">#</a> 设计模式</h2><p>《Design Patterns For Smart Contracts In the Ethereum Ecosystem》</p><h3 id="安全-security" tabindex="-1"><a class="header-anchor" href="#安全-security" aria-hidden="true">#</a> 安全 Security</h3><ul><li><p>Checks-Effects-Interaction 保证状态完整，再做外部调用</p><p>Checks：参数验证，Effects：修改合约状态，Interaction：外部交互 这个模式要求合约按照Checks-Effects-Interaction的顺序来组织代码。它的好处在于进行外部调用之前，Checks-Effects已完成合约自身状态所有相关工作，使得状态完整、逻辑自洽，这样外部调用就无法利用不完整的状态进行攻击</p></li><li><p>Mutex - 禁止递归</p><p>使用修饰符防止函数被递归调用。防止重放攻击</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>contract Mutex <span class="token punctuation">{</span>
