...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>补充一些关于 Java 包和类文件的知识：</p><p>1）Java 中的包主要是为了防止类文件命名冲突以及方便进行代码组织和管理；</p><p>2）对于一个 Java 源代码文件，如果存在 public 类的话，只能有一个 public 类，且此时源代码文件的名称必须和 public 类的名称完全相同。</p><p>另外，如果还存在其他类，这些类在包外是不可见的。如果源代码文件没有 public 类，则源代码文件的名称可以随意命名。</p>`,53),m={href:"https://www.cnblogs.com/dolphin0520/p/3734915.html",target:"_blank",rel:"noopener noreferrer"},u=e("hr",null,null,-1);function b(p,o){const i=v("ExternalLinkIcon");return l(),s("div",null,[c,e("blockquote",null,[e("p",null,[n("原文链接："),e("a",m,[n("https://www.cnblogs.com/dolphin0520/p/3734915.html"),d(i)]),n(" 作者: Matrix海子，编辑：musk")])]),u])}const x=a(r,[["render",b],["__file","access-control.html.vue"]]);export{x as default};
