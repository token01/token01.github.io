...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>\u8BBF\u95EE\u5E94\u7528\u5730\u5740</p></blockquote>`,10),k={href:"http://localhost/",target:"_blank",rel:"noopener noreferrer"},v=i(`<blockquote><p>\u63D0\u793A</p><p>\u542F\u52A8\u670D\u52A1\u7684\u5BB9\u5668<code>docker-compose up ruoyi-mysql ruoyi-server</code></p><p>\u505C\u6B62\u670D\u52A1\u7684\u5BB9\u5668<code>docker-compose stop ruoyi-mysql ruoyi-server</code></p></blockquote><h2 id="_5-\u811A\u672C\u4ECB\u7ECD" tabindex="-1"><a class="header-anchor" href="#_5-\u811A\u672C\u4ECB\u7ECD" aria-hidden="true">#</a> 5. \u811A\u672C\u4ECB\u7ECD</h2><h3 id="_5-1-mysql-dockerfile" tabindex="-1"><a class="header-anchor" href="#_5-1-mysql-dockerfile" aria-hidden="true">#</a> 5.1 mysql-dockerfile</h3><div class="language-docker ext-docker line-numbers-mode"><pre class="language-docker"><code><span class="token comment"># \u57FA\u7840\u955C\u50CF</span>
