import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c,a as n,b as a,d as s,e as t,r as o}from"./app.1ee57811.js";const r={},p=n("h1",{id:"jvm到底是如何运行java代码的",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jvm到底是如何运行java代码的","aria-hidden":"true"},"#"),a(" JVM到底是如何运行Java代码的？")],-1),d={href:"https://mp.weixin.qq.com/s/191I_2CVOxVuyfLVtb4jhg",target:"_blank",rel:"noopener noreferrer"},v=t(`<p>“三妹，我们通常把 Java 分为编译期和运行时，弄清楚这两个阶段就知道原因了。”</p><p>贴一下 HelloWorld 这段代码：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
