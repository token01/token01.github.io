import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as i,a as n,b as l,d as o,e as t,r as c}from"./app.7145ec97.js";const p={},d=n("p",null,"在知乎上看到 R 大的这篇回答，着实感觉需要分享给在座的各位 javaer 们，真心透彻。",-1),r={href:"https://www.zhihu.com/question/52311366/answer/130090347",target:"_blank",rel:"noopener noreferrer"},u=t(`<hr><p>首先是先问是不是再问为什么系列。</p><p>在JDK8u的jdk项目下做个很粗略的搜索：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mymbp:/Users/me/workspace/jdk8u/jdk/src
  ...
  public void bar();
    Code:
      stack=1, locals=2, args_size=1
         ...
         5: goto          2
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>连javac这种几乎什么优化都不做（只做了Java语言规范规定一定要做的常量折叠，和非常少量别的优化）的编译器，对上面俩版本的代码都生成了一样的字节码。后面到解释执行、JIT编译之类的就不用说了，输入都一样，输出也不会不同。</p><hr><p>分享的最后，musk简单说几句。</p><p>可能在我们普通人眼中，这种问题完全没有求真的必要性，但 R大认真去研究了，并且得出了非常令人信服的答案。</p><p>所以，牛逼之人必有三连之处啊。</p><p>以后就可以放心大胆在代码里写 <code>for(;;) while(true)</code> 这样的死循环了。</p><hr>`,25);function v(m,k){const s=c("ExternalLinkIcon");return e(),i("div",null,[d,n("blockquote",null,[n("p",null,[n("a",r,[l("https://www.zhihu.com/question/52311366/answer/130090347"),o(s)])])]),u])}const w=a(p,[["render",v],["__file","jdk-while-for-wuxian-xunhuan.html.vue"]]);export{w as default};
