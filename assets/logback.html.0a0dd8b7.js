import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as i,a as n,b as a,d as s,e as t,r as c}from"./app.c2a49a29.js";const p={},r=n("p",null,"就在昨天，老板听我说完 Logback 有多牛逼之后，彻底动心了，对我下了死命令，“这么好的日志系统，你还不赶紧点，把它切换到咱的项目当中！”",-1),d=n("p",null,"我们项目之前用的 Log4j，在我看来，已经足够用了，毕竟是小公司，性能上的要求没那么苛刻。",-1),u=n("p",null,[n("img",{src:"http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-320329e9-a754-427f-8a19-2e4f809b6a6f.png",alt:"",loading:"lazy"})],-1),g={href:"https://mp.weixin.qq.com/s/AXgNnJe8djD901EmhFkWUg",target:"_blank",rel:"noopener noreferrer"},v={href:"https://mp.weixin.qq.com/s/EhKf1rHWL-QII0f6eo0uVA",target:"_blank",rel:"noopener noreferrer"},m=n("h3",{id:"_01、logback-强在哪",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_01、logback-强在哪","aria-hidden":"true"},"#"),a(" 01、Logback 强在哪")],-1),b=n("p",null,"1）非常自然地实现了 SLF4J，不需要像 Log4j 和 JUL 那样加一个适配层。",-1),k=n("p",null,[n("img",{src:"http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-6ba1b465-5533-49dd-b875-48a10ba29f8e.png",alt:"",loading:"lazy"})],-1),h=n("p",null,"2）Spring Boot 的默认日志框架使用的是 Logback。一旦某款工具库成为了默认选项，那就说明这款工具已经超过了其他竞品。",-1),f=n("p",null,[n("img",{src:"http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-2696cd8b-7e8c-4476-9a06-272fd22fa4b6.png",alt:"",loading:"lazy"})],-1),y={href:"https://docs.spring.io/spring-boot/docs/current/reference/html/spring-boot-features.html#boot-features-logging",target:"_blank",rel:"noopener noreferrer"},q=t(`<p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-82d78a15-8ae0-4377-a7af-aebd5cda4fda.png" alt="" loading="lazy"></p><p>也可以通过源码的形式看得到：</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-2df2d06e-1b01-428b-8444-d765056e25bb.png" alt="" loading="lazy"></p><p>3）支持自动重新加载配置文件，不需要另外创建扫描线程来监视。</p><p>4）既然是巨佬的新作，那必然在性能上有了很大的提升，不然呢？</p><h3 id="_02、logback-使用示例" tabindex="-1"><a class="header-anchor" href="#_02、logback-使用示例" aria-hidden="true">#</a> 02、Logback 使用示例</h3><p><strong>第一步</strong>，在 pom.xml 文件中添加 Logback 的依赖：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Maven 会自动导入另外两个依赖：</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-1f7d8e00-4be6-4863-940c-037862ad2c41.png" alt="" loading="lazy"></p><p>logback-core 是 Logback 的核心，logback-classic 是 SLF4J 的实现。</p><p><strong>第二步</strong>，来个最简单的测试用例：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Logger</span></span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>粘贴到该网址的文本域：</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/logback-6c934584-3624-4f40-8108-13bfffc0c40b.png" alt="" loading="lazy"></p><p>点击「Translate」，可以得到以下内容：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
