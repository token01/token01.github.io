import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as c,c as l,a as n,b as s,d as a,f as i,r as d}from"./app.047e4de1.js";const o={},r=i(`<h1 id="minio\u5BA2\u6237\u7AEFmc\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#minio\u5BA2\u6237\u7AEFmc\u4F7F\u7528" aria-hidden="true">#</a> Minio\u5BA2\u6237\u7AEFmc\u4F7F\u7528</h1><h2 id="_1-\u7B80\u4ECB" tabindex="-1"><a class="header-anchor" href="#_1-\u7B80\u4ECB" aria-hidden="true">#</a> 1. \u7B80\u4ECB</h2><p>MinIO Client (mc)\u4E3Als\uFF0Ccat\uFF0Ccp\uFF0Cmirror\uFF0Cdiff\uFF0Cfind\u7B49UNIX\u547D\u4EE4\u63D0\u4F9B\u4E86\u4E00\u79CD\u66FF\u4EE3\u65B9\u6848\u3002\u5B83\u652F\u6301\u6587\u4EF6\u7CFB\u7EDF\u548C\u517C\u5BB9Amazon S3\u7684\u4E91\u5B58\u50A8\u670D\u52A1\uFF08AWS Signature v2\u548Cv4\uFF09\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">ls</span> \u5217\u51FA\u6587\u4EF6\u548C\u6587\u4EF6\u5939\u3002
mb \u521B\u5EFA\u4E00\u4E2A\u5B58\u50A8\u6876\u6216\u4E00\u4E2A\u6587\u4EF6\u5939\u3002
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930140312806.png" alt="image-20210930140312806"></p><h3 id="_4-2-bucket\u7BA1\u7406" tabindex="-1"><a class="header-anchor" href="#_4-2-bucket\u7BA1\u7406" aria-hidden="true">#</a> 4.2 Bucket\u7BA1\u7406</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># \u521B\u5EFAbucket</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930143222201.png" alt="image-20210930143222201"></p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#\u67E5\u8BE2bucket03\u78C1\u76D8\u4F7F\u7528\u60C5\u51B5</span>
<span class="token function">mc</span> <span class="token function">du</span> minio-server/bucket03
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930145523482.png" alt="image-20210930145523482"></p><h2 id="_5-mc-admin\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#_5-mc-admin\u4F7F\u7528" aria-hidden="true">#</a> 5 mc admin\u4F7F\u7528</h2><p>MinIO Client\uFF08mc\uFF09\u63D0\u4F9B\u4E86\u201C admin\u201D\u5B50\u547D\u4EE4\u6765\u5BF9\u60A8\u7684MinIO\u90E8\u7F72\u6267\u884C\u7BA1\u7406\u4EFB\u52A1\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">service</span> \u670D\u52A1\u91CD\u542F\u5E76\u505C\u6B62\u6240\u6709MinIO\u670D\u52A1\u5668
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930145919383.png" alt="image-20210930145919383"></p><h3 id="_5-2-\u7B56\u7565\u7BA1\u7406" tabindex="-1"><a class="header-anchor" href="#_5-2-\u7B56\u7565\u7BA1\u7406" aria-hidden="true">#</a> 5.2 \u7B56\u7565\u7BA1\u7406</h3><p>policy\u547D\u4EE4\uFF0C\u7528\u4E8E\u6DFB\u52A0\uFF0C\u5220\u9664\uFF0C\u5217\u51FA\u7B56\u7565\uFF0C\u83B7\u53D6\u6709\u5173\u7B56\u7565\u7684\u4FE1\u606F\u5E76\u4E3AMinIO\u670D\u52A1\u5668\u4E0A\u7684\u7528\u6237\u8BBE\u7F6E\u7B56\u7565\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">mc</span> admin policy <span class="token parameter variable">--help</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930151708195.png" alt="image-20210930151708195"></p><h4 id="_5-2-2-\u8BBE\u7F6E\u7528\u6237\u8BBF\u95EE\u7B56\u7565" tabindex="-1"><a class="header-anchor" href="#_5-2-2-\u8BBE\u7F6E\u7528\u6237\u8BBF\u95EE\u7B56\u7565" aria-hidden="true">#</a> 5.2.2 \u8BBE\u7F6E\u7528\u6237\u8BBF\u95EE\u7B56\u7565</h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">mc</span> admin user <span class="token function">add</span> minio-server fox03 <span class="token number">12345678</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20210930152101436.png" alt="image-20210930152101436"></p>`,35),m={href:"http://192.168.3.14:50000/%EF%BC%8C%E5%8F%AA%E8%83%BD%E6%93%8D%E4%BD%9Ctulingmall%E7%9A%84bucket",target:"_blank",rel:"noopener noreferrer"},v=n("h2",{id:"\u53C2\u8003\u6587\u7AE0",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#\u53C2\u8003\u6587\u7AE0","aria-hidden":"true"},"#"),s(" \u53C2\u8003\u6587\u7AE0")],-1),b={href:"http://docs.minio.org.cn/docs/master/minio-client-quickstart-guide",target:"_blank",rel:"noopener noreferrer"};function h(k,g){const e=d("ExternalLinkIcon");return c(),l("div",null,[r,n("p",null,[n("a",p,[s("\u4E0B\u8F7D\u5730\u5740"),a(e)])]),u,n("p",null,[s("\u6D4B\u8BD5\uFF1Afox03/12345678 \u767B\u5F55minio\u63A7\u5236\u53F0"),n("a",m,[s("http://192.168.3.14:50000/\uFF0C\u53EA\u80FD\u64CD\u4F5Ctulingmall\u7684bucket"),a(e)])]),v,n("p",null,[n("a",b,[s("MinIO\u5BA2\u6237\u7AEF\u5FEB\u901F\u5165\u95E8\u6307\u5357"),a(e)])])])}const q=t(o,[["render",h],["__file","minio-mc-use.html.vue"]]);export{q as default};
