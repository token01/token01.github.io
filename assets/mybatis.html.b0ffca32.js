import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as d,a as e,b as n,d as s,e as t,r}from"./app.84e5f037.js";const o={},u=e("p",null,"ORM 框架的本质是简化操作数据库的编码工作，常用的框架有两个，一个是可以灵活执行动态 SQL 的 MyBatis；一个是崇尚不用写 SQL 的 Hibernate。前者互联网行业用的多，后者传统行业用的多。",-1),v=e("p",null,"Hibernate 的特点是所有的 SQL 通过 Java 代码生成，发展到最顶端的就是 Spring Data JPA，基本上根据方法名就可以生成对应的 SQL 了。",-1),c={href:"https://tobebetterjavaer.com/springboot/jpa.html",target:"_blank",rel:"noopener noreferrer"},p={href:"https://tobebetterjavaer.com/kaiyuan/auto-generator.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://baomidou.com/",target:"_blank",rel:"noopener noreferrer"},b=t(`<h3 id="整合-mybatis" tabindex="-1"><a class="header-anchor" href="#整合-mybatis" aria-hidden="true">#</a> 整合 MyBatis</h3><p>第一步，在 pom.xml 文件中引入 starter。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
&lt;mapper namespace=&quot;top.codingmore.mapper.PostMapper&quot;&gt;
    ...
    &lt;/delete&gt;
&lt;/mapper&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接口中方法对应的 SQL 直接写在 xml 文件中，具体位置见下图：</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/mybatis-cc8515b1-e501-41e2-8dea-7612022e1bb7.png" alt="" loading="lazy"></p><p>也可以看文件放在和 PostMapper.java 接口同级的目录下，但是这样会带来一个问题，就是 Maven 打包的时候默认会忽略 xml 文件，所以为了避免这种情况发生，我们需要在 pom.xml 文件中添加配置：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;build&gt;
    &lt;resources&gt;
        &lt;resource&gt;
...
&lt;/select&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>细心的小伙伴应该可以看到 <code>\${ew.sqlSegment}</code> 这样的表达式，它属于 MyBatis-Plus 中的内容。</p><h3 id="通过-mybatis-plus-增强" tabindex="-1"><a class="header-anchor" href="#通过-mybatis-plus-增强" aria-hidden="true">#</a> 通过 MyBatis-Plus 增强</h3>`,38),g={href:"https://tobebetterjavaer.com/springboot/jpa.html",target:"_blank",rel:"noopener noreferrer"},h=e("p",null,"MP 提供了诸多优秀的特性，比如说：",-1),q=e("li",null,"强大的 CRUD 操作：内置了通用的 mapper、service，可通过少量的配置实现大部分常用的 CRUD，不用再编写 SQL 语句。",-1),_=e("li",null,"支持主键自动生成",-1),x=e("li",null,"支持 ActiveRecord 模式：实体类只需继承 Model 类即可进行强大的 CRUD 操作",-1),y={href:"https://tobebetterjavaer.com/kaiyuan/auto-generator.html",target:"_blank",rel:"noopener noreferrer"},M=e("li",null,"内置分页插件",-1),f=e("li",null,"内置性能分析插件：可输出 SQL 语句以及其执行时间",-1),S=t(`<p>我们直接进入实战。</p><p>第一步，在 pom.xml 文件中添加 MyBatis-Plus 的 starter。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的数据库表为 post-tag。</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/mybatis-d4471207-9284-43bf-b1aa-50bbc6001a9f.png" alt="" loading="lazy"></p><p>可以看得出，类名 PostTag，字段名 postTagId 和数据库表 post_tag、字段名 post_tag_id 并不一致，但 mp 自动帮我们做了映射关联。</p><p>第二步，新建 PostTagMapper 继承 BaseMapper，继承该接口后，无需编写 mapper.xml 文件，即可获得CRUD功能。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public interface PostTagMapper extends BaseMapper&lt;PostTag&gt; {}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>BaseMapper里提供的方法如下：</p><p><img src="http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/mybatis-79ac66eb-25fd-44a0-8668-359d1b95b80d.png" alt="image.png" loading="lazy"></p><p>第三步，在测试类中添加查询方法。</p><hr>`,14),T={href:"https://tobebetterjavaer.com/zhishixingqiu/",target:"_blank",rel:"noopener noreferrer"},k=e("strong",null,"编程喵",-1),L=e("h3",{id:"源码路径",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#源码路径","aria-hidden":"true"},"#"),n(" 源码路径")],-1),P={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},A={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-mybatis",target:"_blank",rel:"noopener noreferrer"},B=e("hr",null,null,-1);function E(I,U){const i=r("ExternalLinkIcon");return l(),d("div",null,[u,v,e("p",null,[e("a",c,[n("Spring Boot 整合 JPA"),s(i)])]),e("p",null,[n("MyBatis 早些时候用起来比较繁琐，需要各种配置文件，需要实体类和 DAO 的映射关联，经过不断地演化和改进，可以通过 "),e("a",p,[n("generator"),s(i)]),n(" 自动生成实体类、配置文件和 DAO 层代码，简化了不少开发工作。")]),e("p",null,[n("随着 "),e("a",m,[n("MyBatis-Plus"),s(i)]),n(" 的出现，又进一步加速了 MyBatis 的发展。经过 MyBatis-Plus 的增强，开发者只需要简单的配置，就可以快速进行单表的 CRUD 操作；同时，MyBatis-Plus又提供了代码生成、自动分页、逻辑删除、自动填充等丰富功能，进一步简化了开发工作。")]),b,e("p",null,[n("MyBatis 属于半自动的 ORM 框架，实现一些简单的 CRUD 也是需要编写 SQL 语句，那如果想省掉这些步骤的话，可以选择 "),e("a",g,[n("JPA"),s(i)]),n("，也可以选择国人开源的 MyBatis-Plus（简称 MP）。")]),h,e("ul",null,[q,_,x,e("li",null,[e("a",y,[n("强大的代码生成器"),s(i)]),n("：可快速生成 Mapper 、 Model 、 Service 、 Controller 层代码")]),M,f]),S,e("p",null,[n("更多内容，只针对《Java 程序员进阶之路》星球用户开放，需要的小伙伴可以"),e("a",T,[n("戳链接🔗"),s(i)]),n("加入我们的星球，一起学习，一起卷。。"),k,n("🐱是一个 Spring Boot+Vue 的前后端分离项目，融合了市面上绝大多数流行的技术要点。通过学习实战项目，你可以将所学的知识通过实践进行检验、你可以拓宽自己的技术边界，你可以掌握一个真正的实战项目是如何从 0 到 1 的。")]),L,e("ul",null,[e("li",null,[n("编程喵："),e("a",P,[n("https://github.com/itwanger/coding-more"),s(i)])]),e("li",null,[n("codingmore-mybatis："),e("a",A,[n("https://github.com/itwanger/codingmore-learning"),s(i)])])]),B])}const w=a(o,[["render",E],["__file","mybatis.html.vue"]]);export{w as default};
