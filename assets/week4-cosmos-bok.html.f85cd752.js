import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as i,f as s}from"./app.9ff179fe.js";const d={},l=s(`<p><img src="https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/202212282244825.png" alt="image.png"></p><h3 id="\u5177\u4F53\u6267\u884C\u6B65\u9AA4" tabindex="-1"><a class="header-anchor" href="#\u5177\u4F53\u6267\u884C\u6B65\u9AA4" aria-hidden="true">#</a> \u5177\u4F53\u6267\u884C\u6B65\u9AA4</h3><hr><h3 id="\u672C\u5730\u6267\u884C\u6B65\u9AA4" tabindex="-1"><a class="header-anchor" href="#\u672C\u5730\u6267\u884C\u6B65\u9AA4" aria-hidden="true">#</a> \u672C\u5730\u6267\u884C\u6B65\u9AA4</h3><p><strong>1.</strong> \u7528ignite\u751F\u6210\u4E00\u6761\u65B0\u7684\u533A\u5757\u94FE\u540D\u5B57\u53EBplanet\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold chain planet --no-module
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>2.</strong> \u4F7F\u7528ignite\u751F\u6210\u4E00\u4E2ABlog\u7684\u6A21\u5757\uFF0C\u5E76\u4E14\u96C6\u6210IBC\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold module blog --ibc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>3.</strong> \u7ED9blog\u6A21\u5757\u6DFB\u52A0\u9488\u5BF9\u535A\u6587\uFF08post\uFF09\u7684\u589E\u5220\u6539\u67E5\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold list post title content creator --no-message --module blog

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>4.</strong> \u6DFB\u52A0\u5DF2\u53D1\u751F\u6210\u529F\u535A\u6587\uFF08sentPost\uFF09\u7684\u589E\u5220\u6539\u67E5\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold list sentPost postID title chain creator --no-message --module blog
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>5.</strong> \u6DFB\u52A0\u53D1\u9001\u8D85\u65F6\u535A\u6587\uFF08timeoutPost\uFF09\u7684\u589E\u5220\u6539\u67E5\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold list timedoutPost title chain creator --no-message --module blog
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>6.</strong> \u6DFB\u52A0IBC\u53D1\u9001\u6570\u636E\u5305\u548C\u786E\u8BA4\u6570\u636E\u5305\u7684\u7ED3\u6784\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold packet ibcPost title content --ack postID --module blog

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5177\u4F53\u6267\u884C\u4FEE\u6539\u5185\u5BB9</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite scaffold packet updatePost postID title content --ack postID --module blog

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>7.</strong> \u5728proto/blog/packet.proto\u76EE\u5F55\u4E0B\u4FEE\u6539<code>IbcPostPacketData</code>\uFF0C\u6DFB\u52A0\u521B\u5EFA\u4EBA<code>Creator</code>\uFF0C \u5E76\u91CD\u65B0\u7F16\u8BD1proto\u6587\u4EF6\u3002\u5728x/blog/keeper/msg_server_ibc_post.go\u3002\u7F16\u8BD1\u5B8C\u6210\u540E\u5728x/blog/keeper/msg_server_ibc_post.go\u4E2D\u53D1\u9001\u6570\u636E\u5305\u524D\u66F4\u65B0<code>Creator</code>\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ignite chain build
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>8.</strong> \u4FEE\u6539keeper\u65B9\u6CD5\u4E2D\u7684<code>OnRecvIbcPostPacket </code>\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>id := k.AppendPost(
        ctx,
        types.Post{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>9.</strong> \u4FEE\u6539keeper\u65B9\u6CD5\u4E2D\u7684<code>OnAcknowledgementIbcPostPacket </code>\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>k.AppendSentPost(
            ctx,
            types.SentPost{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>10.</strong> \u4FEE\u6539keeper\u65B9\u6CD5\u4E2D\u7684<code>OnTimeoutIbcPostPacket </code>\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>k.AppendTimedoutPost(
        ctx,
        types.TimedoutPost{
            Creator: data.Creator,
            Title:   data.Title,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>11.</strong> \u6DFB\u52A0\u94FE\u542F\u52A8\u7684\u914D\u7F6E\u6587\u4EF6\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code># earth.yml
accounts:
  - name: alice
...
init:
  home: &quot;$HOME/.mars&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u914D\u7F6E\u6587\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u6587\u4EF6" aria-hidden="true">#</a> \u914D\u7F6E\u6587\u4EF6</h3><h3 id="\u542F\u52A8\u94FE\u547D\u4EE4-1" tabindex="-1"><a class="header-anchor" href="#\u542F\u52A8\u94FE\u547D\u4EE4-1" aria-hidden="true">#</a> \u542F\u52A8\u94FE\u547D\u4EE4\uFF081\uFF09</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Your saved project changes have not been committed.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,39),t=[l];function a(u,v){return n(),i("div",null,t)}const o=e(d,[["render",a],["__file","week4-cosmos-bok.html.vue"]]);export{o as default};
