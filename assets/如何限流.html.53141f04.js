import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as p,a as n,b as a,d as t,e as s,r as c}from"./app.af6359e2.js";const o={},u=s('<h2 id="如何限流" tabindex="-1"><a class="header-anchor" href="#如何限流" aria-hidden="true">#</a> 如何限流</h2><blockquote><p>限流一般是一种保护系统稳定性的一种措施。在开放API中比较常见。<br> 对某一用户，或指定IP，或具体到某个API，在一个具体的时间里限制请求次数。</p></blockquote><p>关键词</p><ul><li>熔断</li><li>服务降级</li><li>延迟处理</li><li>特权处理</li></ul><h2 id="主流框架的实现" tabindex="-1"><a class="header-anchor" href="#主流框架的实现" aria-hidden="true">#</a> 主流框架的实现</h2><p>首先看看主要的框架是使用，再讨论自己怎么实现</p><h3 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> Nginx</h3><p>Nginx 自带的两个限流模块</p>',8),r=n("li",null,"ngx_http_limit_conn_module 连接数限流模块",-1),d=n("li",null,"ngx_http_limit_req_module 请求数限流模块",-1),v=n("li",null,"ngx_lua",-1),k=n("li",null,"ngx_lua_waf模块",-1),m={href:"https://openresty.org/",target:"_blank",rel:"noopener noreferrer"},b=s(`<p>ngx_http_limit_conn_module</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>http {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>rate=1r/s 固定请求速率设置，每秒1个请求。</p>`,6),g={href:"https://www.nenew.net/use-nginx-configure-to-protect-cc-attack.html",target:"_blank",rel:"noopener noreferrer"},h=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>http{
    ...
...
可能在sentinel dashboard上不显示，请求一下个个服务试试
  ...
  cloud:
    ...
    sentinel:
      ...
      enabled: true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),w=s(`<li><p>基于nacos config</p><p>application.yml</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
  application:
    name: zzz-gateway
  cloud:
    nacos:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14);function R(N,P){const e=c("ExternalLinkIcon");return l(),p("div",null,[u,n("ul",null,[r,d,v,k,n("li",null,[n("a",m,[a("OpenResty"),t(e)])])]),b,n("p",null,[n("a",g,[a("抵御CC攻击"),t(e)])]),h,n("p",null,[a("Spring Cloud Netflix 诸多组件不在更新维护后 Spring Cloud也正式加入了"),n("a",_,[a("spring-cloud-alibaba"),t(e)]),n("a",y,[a("Sentinel"),t(e)]),a("就是其中一员，它把流量作为切入点，从流量控制、熔断降级、系统负载保护等多个维度保护服务的稳定性")]),x,n("ul",null,[n("li",null,[f,n("p",null,[a("下载 sentinel-dashboard "),n("a",q,[a("https://github.com/alibaba/Sentinel/releases"),t(e)])]),I]),w,n("li",null,[n("p",null,[a("基于代码 "),n("a",z,[a("https://github.com/alibaba/Sentinel/wiki/如何使用"),t(e)])])])]),S])}const A=i(o,[["render",R],["__file","如何限流.html.vue"]]);export{A as default};
