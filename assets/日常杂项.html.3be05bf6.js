...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="git" tabindex="-1"><a class="header-anchor" href="#git" aria-hidden="true">#</a> Git</h2><h3 id="github-tips" tabindex="-1"><a class="header-anchor" href="#github-tips" aria-hidden="true">#</a> Github Tips</h3><ul><li>Clone 太慢超时</li></ul><p>使用<code>cnpmjs.org</code> CND</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/ifuture-pro/developer-notes
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>图片都裂了</li></ul>`,12),E=n("br",null,null,-1),S={href:"https://www.ipaddress.com/",target:"_blank",rel:"noopener noreferrer"},q=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vim</span> /etc/hosts
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>图床</li></ul>`,2),w={href:"https://www.jsdelivr.com/?docs=gh",target:"_blank",rel:"noopener noreferrer"},A=n("code",null,"githubusercontent.com",-1),O=n("ul",null,[n("li",null,"在线阅读")],-1),C=n("br",null,null,-1),D={href:"https://github.dev/jupyterhub/jupyterhub",target:"_blank",rel:"noopener noreferrer"},N={href:"https://gitpod.io/",target:"_blank",rel:"noopener noreferrer"},R=n("br",null,null,-1),j={href:"https://gitpod.io/#/github.com/jupyterhub/jupyterhub",target:"_blank",rel:"noopener noreferrer"},I=i(`<h3 id="基础" tabindex="-1"><a class="header-anchor" href="#基础" aria-hidden="true">#</a> 基础</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&quot;# Hello World&quot;</span> <span class="token operator">&gt;&gt;</span> README.md
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,19),T={href:"https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line",target:"_blank",rel:"noopener noreferrer"},L={href:"https://$GITHUB_ACTOR:$GH_TOKEN@github.com/owner/repo.git",target:"_blank",rel:"noopener noreferrer"},M=n("p",null,"或使用 ssh",-1),z=n("h3",{id:"github",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#github","aria-hidden":"true"},"#"),s(" Github")],-1),P={href:"https://help.github.com/articles/guide-to-submitting-a-dmca-takedown-notice/",target:"_blank",rel:"noopener noreferrer"},X=n("h3",{id:"其他",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#其他","aria-hidden":"true"},"#"),s(" 其他")],-1),B={href:"https://www.gerritcodereview.com/",target:"_blank",rel:"noopener noreferrer"},G={href:"http://gitstats.sourceforge.net/",target:"_blank",rel:"noopener noreferrer"},H={href:"https://github.com/521xueweihan/git-tips",target:"_blank",rel:"noopener noreferrer"},U=n("img",{src:o,alt:"",loading:"lazy"},null,-1),V=i(`<h2 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> Docker</h2><h3 id="基础安装" tabindex="-1"><a class="header-anchor" href="#基础安装" aria-hidden="true">#</a> 基础安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 卸载</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常用目录位置" tabindex="-1"><a class="header-anchor" href="#常用目录位置" aria-hidden="true">#</a> 常用目录位置</h2><ul><li><p>系统自启动</p><ul><li>MAC <code>~/Library/LaunchAgents</code><ul><li>/Library/StartupItems</li><li>/System/Library/StartupItems</li></ul></li></ul></li><li><p>Lantern</p><ul><li>MAC <code>~/Library/Application\\ Support/Lantern/settings.yaml</code></li></ul></li><li><p>Docker</p><ul><li>Ubuntu: /var/lib/docker/</li><li>Fedora: /var/lib/docker/</li><li>Debian: /var/lib/docker/</li><li>Windows: C:\\ProgramData\\DockerDesktop</li><li>MacOS: ~/Library/Containers/com.docker.docker/Data/vms/0/</li></ul></li><li><p>Xcode</p><ul><li>xcarchive: ~/Library/Developer/Xcode/Archives</li></ul></li></ul>`,10);function $(K,F){const a=c("ExternalLinkIcon");return l(),r("div",null,[d,n("ul",null,[u,m,n("li",null,[s("iozone 文件系统IO测试 "),n("a",v,[s("云主机大PK"),e(a)])])]),b,n("ul",null,[n("li",null,[n("a",h,[s("https://bastian.rieck.me/blog/posts/2019/ssh_incidents/"),e(a)]),s(" 分析恶意的SSH访问尝试")])]),k,n("p",null,[n("a",g,[s("dirmap"),e(a)]),s("、"),n("a",f,[s("webdirscan"),e(a)]),s("、DirBuster、Dirsearch、cansina")]),_,n("p",null,[s("hydra，Bruter，Medusa，"),n("a",x,[s("hashcat"),e(a)])]),y,n("p",null,[s("基本是都是被 DNS 污染了"),E,n("a",S,[s("查询域名指向的IP地址"),e(a)]),s(" 修改 hosts 文件")]),q,n("p",null,[s("基于"),n("a",w,[s("jsdelivr CDN"),e(a)]),s(" 可实现无差异访问,不担心"),A,s(" 无法访问问题")]),O,n("p",null,[s("直接按【.】建将打开web vscode在线阅读代码。"),C,n("a",D,[s("https://github.dev/jupyterhub/jupyterhub"),e(a)])]),n("ul",null,[n("li",null,[s("在线运行 在地址前面输入"),n("a",N,[s("https://gitpod.io/"),e(a)]),s("# 将打开一个在线的vscode及linux容器"),R,n("a",j,[s("https://gitpod.io/#/github.com/jupyterhub/jupyterhub"),e(a)])])]),I,n("p",null,[n("a",T,[s("https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line"),e(a)]),s(" 建议使用token作为密码")]),n("p",null,[s("或使用带 token url "),n("a",L,[s("https://$GITHUB_ACTOR:$GH_TOKEN@github.com/owner/repo.git"),e(a)])]),M,z,n("p",null,[n("a",P,[s("Github DMCA"),e(a)]),s("数字千年版权法")]),X,n("p",null,[n("a",B,[s("codereview"),e(a)]),n("a",G,[s("git stats"),e(a)])]),n("p",null,[n("a",H,[U,e(a)])]),V])}const J=t(p,[["render",$],["__file","日常杂项.html.vue"]]);export{J as default};
