...
tag:
  - Java重要知识点
description: 凤凰涅槃进阶之路，小白的零基础Java教程，从入门到进阶，深入理解Java中的泛型
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰涅槃进阶之路,Java入门,教程,java,泛型
---

“musk，为什么要设计泛型啊？”三妹开门见山地问。
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/generic/generic-01.png)
...
“哦，明白了。”三妹若有所思的点点头，“musk，听说虚拟机没有泛型？”
...
“musk，类型擦除会有什么问题吗？”三妹又问了一个很有水平的问题。
...
“对泛型机制讲的也很透彻，你结合musk给你讲的这些，再深入的学习一下。”
