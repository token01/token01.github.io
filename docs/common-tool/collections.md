...
tag:
  - 常用工具类
description: 凤凰涅槃进阶之路，小白的零基础Java教程，从入门到进阶，Java Collections：专为集合框架而生的工具类
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰涅槃进阶之路,Java入门,教程,java,Collections,集合框架
---
...
System.out.println("出现的次数：" + Collections.frequency(list, "musk"));

// 没有排序直接调用二分查找，结果是不确定的
System.out.println("排序前的二分查找结果：" + Collections.binarySearch(list, "musk"));
Collections.sort(list);
// 排序后，查找结果和预期一致
