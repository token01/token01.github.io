...
![image-20211220202249659](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211220202249659.png)
...
![image-20211220202329079](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211220202329079.png)

所以我们可以建立**复合索引 db.flights.createIndex({ flight: 1, price: 1 },{background: true})**

![image-20211220202348127](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211220202348127.png)
