...
![image-20211027203631278](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027203631278.png)

### 2.2 触发器Trigger

有了任务之后，还需要一个能够实现触发任务去执行的触发器，触发器Trigger最基本的功能是指定Job的执行时间，执行间隔，运行次数等。

![image-20211027203739489](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027203739489.png)

### 2.3 调度器 Schedule

有了Job和Trigger后，怎么样将两者结合起来呢？即怎样指定Trigger去执行指定的Job呢？这时需要一个Schedule，来负责这个功能的实现。

![image-20211027203820564](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027203820564.png)
...
![image-20211027203158947](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027203158947.png)
...
![image-20211027204136389](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027204136389.png)
...
主要信息有：
![image-20211027204531035](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027204531035.png)
...
![image-20211027205941975](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027205941975.png)

可通过在线生成Cron表达式的工具：http://cron.qqe2.com/ 来生成自己想要的表达式。

![image-20211027210001186](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/image-20211027210001186.png)
