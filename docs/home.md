...
- [Spring Boot 整合 Knife4j，美化强化丑陋的Swagger](tool/knife4j.md)
...
- [Chocolatey：一款GitHub星标8.2k+的Windows命令行软件管理器，好用到爆！](tool/choco.md)
- [Homebrew，GitHub 星标 32.5k+的 macOS 命令行软件管理神器，功能真心强大！](tool/brew.md)
- [Tabby：一款逼格更高的开源终端工具，GitHub 星标 21.4k](tool/tabby.md)
- [Warp：号称下一代终端神器，GitHub星标2.8k+，用完爱不释手](tool/warp.md)
- [WindTerm：新一代开源免费的终端工具，GitHub星标6.6k+，太酷了！](tool/windterm.md)
- [chiner：干掉 PowerDesigner，国人开源的数据库设计工具，界面漂亮，功能强大](tool/chiner.md)
- [DBeaver：干掉付费的 Navicat，操作所有数据库就靠它了！](tool/DBeaver.md)

### 开源轮子

- [Forest：一款极简的声明式HTTP调用API框架](tool/forest.md)
- [Junit：一个开源的Java单元测试框架](tool/junit.md)
- [fastjson：阿里巴巴开源的JSON解析库](tool/fastjson.md)
- [Gson：Google开源的JSON解析库](tool/gson.md)
- [Jackson：GitHub上star数最多的JSON解析库](tool/jackson.md)
- [Log4j：Java日志框架的鼻祖](tool/log4j.md)
- [Log4j 2：Apache维护的一款高性能日志记录工具](tool/log4j2.md)
- [Logback：Spring Boot内置的日志处理框架](tool/logback.md)
- [SLF4J：阿里巴巴强制使用的日志门面担当](tool/slf4j.md)
