...
tag:
  - Java IO
description: Web2.0至3.0进阶之路，小白的零基础Java教程，Java缓冲流（Buffered）：读写速度有了质的飞升
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,Web2.0至3.0进阶之路,Java入门,教程,IO,缓冲流,Buffered,BufferedInputStream,BufferedOutputStream,BufferedReader,BufferedWriter
---
