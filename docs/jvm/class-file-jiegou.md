...
tag:
  - Java虚拟机
description: Web2.0至3.0进阶之路，小白的零基础Java教程，从入门到进阶，详解Java的类文件（class文件）结构
head:
  - - meta
    - name: keywords
      content: Java,JavaSE,教程,Web2.0至3.0进阶之路,jvm,Java虚拟机,class
---
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/class-file-jiegou-423341a7-3aeb-4ac9-95e8-a1e7f7847255.png)
