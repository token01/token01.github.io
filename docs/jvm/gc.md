...
tag:
  - Java虚拟机
description: 凤凰涅槃进阶之路，小白的零基础Java教程，从入门到进阶，咱们从头到尾说一次Java垃圾回收
head:
  - - meta
    - name: keywords
      content: Java,JavaSE,教程,凤凰涅槃进阶之路,jvm,Java虚拟机,垃圾回收,gc
---
...
>- 整理：musk，原文链接：https://zhuanlan.zhihu.com/p/73628158
