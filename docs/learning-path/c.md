...
<!-- ![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-1.png)

直接长按识别/扫描下方二维码，关注后回复 「**08**」 下载这份 PDF 吧：

![扫码关注后回复「08」关键字](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/gongzhonghao.png) -->
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-2.png)

>视频地址：[https://www.icourse163.org/course/ZJU-199001](https://www.icourse163.org/course/ZJU-199001)

看完这套视频，大家至少能学到：

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-3.jpg)
...
![C语言之父](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-1.jpg)

Dennis Ritchie是这样评价自己的亲儿子的：“**古怪的、有缺陷的，但同时也是一个巨大的成功**。”这句评语还是非常中肯的。

**第一，C语言在计算机领域起到了承上启下的作用**。

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-4.jpg)
...
![MATLAB+C语言来控制机械臂](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-2.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-5.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-6.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-7.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-8.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-9.png)


给高中生、大一新生看的入门书《c primer plus》，语法全覆盖，细节多，知识点讲的清楚，缺点是琐碎，细节弯弯绕。


![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-10.png)


还有一本《C 程序设计语言》，这本书的作者是 C语言之父，所以全书讲的都是 C语言的核心。代码示例大多都是库函数的实现方法，内容简洁明了，干净利落，没有废话。

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-11.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-12.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/c-books.jpg)
...
到此为止，C语言的重点就全部划出来了，剩下的学习就交给大家了。最后，musk再唠叨几句：
