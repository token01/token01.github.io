...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-primer-book.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-2.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-3.png)

第四本《深度探索C++对象模型》，侯捷老师译的，这本书讲解了 C++ 面向对象特性的底层实现机制，读起来虽然有点晦涩，但读完后就会搞明白“代码跑起来的时候实际发生了什么”。

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-4.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-b3de882e-3b4e-453e-a9b7-e327ca7ec30e.png)


<!-- 我从网上 down 了一份，保存到了本地。需要的小伙伴请长按识别/扫描下方的二维码关注作者的原创公众号「**musk**」回复关键字「**cpp**」就可以拉取到了。

![回复关键字 cpp ](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/gongzhonghao.png) -->

给大家看一下我保存的这些视频资源哈。

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-5.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/cpp-books.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-7c451ad4-73e5-4ac4-a9e5-d0bdbae06ff0.jpg)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/ccc-3e0137d4-f0f3-4a1d-8e6c-c16eefcd175d.jpg)
