...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-map.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-map-1.png)

### **2）视频**

懂的都懂，看视频到 B 站。黑马的《Java并发编程》评价还不错，300 多个小节，我觉得讲的比较好的有三部分：synchronized优化原理、AQS和线程池。

![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-4.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-5.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-6.png)

>GitHub地址：[https://github.com/RedSpider1/concurrent](https://github.com/RedSpider1/concurrent)

<!-- 考虑到有些小伙伴可能需要 [PDF 版本](https://mp.weixin.qq.com/s/pxKrjw_5NTdZfHOKCkwn8w)，我花了一周的时间整理了一份，需要的小伙伴请扫描下方的二维码关注作者的原创公众号「**musk**」回复关键字「**并发**」就可以拉取到了。

![扫码关注后回复「并发」关键字](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/gongzhonghao.png) -->
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-7.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-8.png)
...
![](https://abelsun-1256449468.cos.ap-beijing.myqcloud.com/image/java-thread-9.jpg)
