...
大家好，我是musk呀！最近又有一个读者来咨询我的建议：**应届生，要求 Java 进去后转 Go，问我咋样？**
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/xuexiluxian/go-11.jpg)
...
<!-- 需要的小伙伴请长按识别/扫描下方的二维码关注作者的原创公众号「**musk**」回复关键字「**go**」就可以拉取到了。
