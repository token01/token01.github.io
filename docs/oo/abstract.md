...
shortTitle: Java抽象类
description: 凤凰涅槃进阶之路，小白的零基础Java教程，认真聊聊 Java抽象类
category:
  - Java 核心
tag:
  - 面向对象编程
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰涅槃进阶之路,Java入门,教程,Java抽象类,抽象类
---


“musk，你这明显加快了更新的频率呀！”三妹对于我最近的肝劲由衷的佩服了起来。
...
“musk，抽象方法我明白了，那什么时候使用抽象方法呢？能给我讲讲它的应用场景吗？”三妹及时的插话道。
