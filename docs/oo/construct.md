...
description: 凤凰蜕变进阶之路，小白的零基础Java教程，认真聊聊 Java中的构造方法：对象创建时的必经之路
category:
  - Java 核心
tag:
  - 面向对象编程
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰蜕变进阶之路,Java入门,教程,Java构造方法,构造方法
---
...
“musk，默认构造方法的目的是什么？它为什么是一个空的啊？”三妹疑惑地看着我，提出了这个尖锐的问题。
...
“好的，musk，我的问题问完了，今天的学习可以结束了！”三妹一脸得意的样子。
