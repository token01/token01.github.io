...
shortTitle: Java接口
description: 凤凰蜕变进阶之路，小白的零基础Java教程，认真聊聊Java接口
category:
  - Java 核心
tag:
  - 面向对象编程
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰蜕变进阶之路,Java入门,教程,接口
---
...
“musk，开讲之前，先恭喜你呀。我看你朋友圈说《Java 程序员进阶之路》开源知识库收到了第一笔赞赏呀，虽然只有一块钱，但我也替你感到开心。”三妹的脸上洋溢着自信的微笑，仿佛这钱是打给她的一样。
