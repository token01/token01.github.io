...
tag:
  - Java网络编程
description: 架构师进阶之路，小白的零基础Java教程，在 Java 中，网络套接字（Socket）扮演着“飞鸽传书”的角色。
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,架构师进阶之路,Java入门,教程,JavaSocket,java网络编程,socket,网络编程
---
