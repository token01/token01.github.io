...
class CodingmoreJpaApplicationTests {
    ...
    void contextLoads() {
        ...
        // 新增数据
        userService.save(new User().setId(2).setAge(12).setName("musk三").setPassword("123456"));
        userService.save(new User().setId(3).setAge(12).setName("musk四").setPassword("123456"));
        userService.save(new User().setId(4).setAge(12).setName("musk五").setPassword("123456"));
