...
tag:
  - 数组&字符串
description: 凤凰蜕变进阶之路，小白的零基础Java教程，从入门到进阶，Java如何判断两个字符串是否相等？
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,凤凰蜕变进阶之路,Java入门,教程,java字符串,String,equals
---


“musk，如何比较两个字符串相等啊？”三妹问。
