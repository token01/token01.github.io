...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-726f97d9-4de2-4d23-9973-d1a39951a0f7.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-e7eaf096-7477-4ed0-814a-07ef8d62884f.png)

但过来人告诉你，别选其他镜像源，就选中科大，速度杠杠的，40-50M/s，这速度比其他镜像源快多了，对比起来，其他就是蜗牛🐌。



![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-f0c3c481-f474-47b2-8b5e-17f8fc2b9a80.png)



这个安装脚本非常的智能，几乎可以一件帮我们搞定所有问题。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-7c539545-d26e-45e8-9f81-bb5b439342eb.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-aebf4ced-58f4-4d31-892c-4a8382cf3677.png)

brew 本体安装成功后，会提示我们配置国内镜像源。


![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-6866eb09-75fb-4f19-9ff4-b80fd02816e9.png)

nice，安装完成了。执行下面这几个命令体验下。


![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-33bcd6a1-d843-4a6c-a8ac-0d908095da79.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-ac0e141f-301c-46f1-bd80-5375eb50dc4d.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-c5403959-01fd-4610-b08c-4ca4e4cb0a66.png)

brew 是从下载源码开始，然后编译（不一定，有些有现成的 bottle）解压，通过 `./configure && make install` 进行安装，同时会包含相关的依赖库。环境变量也是自动配置的。


![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-d27ec07e-cf3c-4504-9174-60881d2710fb.png)


brew cask 是下载解压已经编译好了的软件包（.dmg/.pkg），放在统一的目录中，省去了手动去下载、解压、拖拽等蛋疼步骤。


![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-566f4437-62de-49e5-89a7-7c666a2ad9c1.png)

通过 `brew search google` 我们也可以看得出两者之间的区别。


![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-441127b1-f7ae-484e-801b-5b808f8e283c.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-b4d7684b-2db8-4286-bf2e-389c2aed5968.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-1034fcfd-22a7-4968-8b6f-fb2e67d22855.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-2e10e772-1944-474a-bbfa-b3ef3e0ec9d4.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-4819ca75-01e3-4dea-8859-7c9ddd570142.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-e934f3f3-c7de-4537-8c30-73c0e9fb41b4.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/brew-8fb73388-ffaf-4241-8584-03e7aa00578b.png)
