...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-1.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-2.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-3.gif)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-4.png)

安装完成后首次打开的样子是这样的。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-5.png)

chiner 提供了非常贴心的操作手册和参考模板，如果时间比较充分的话，可以先把操作手册过一遍，写得非常详细。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-6.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-7.png)

第三步，选择要添加的数据表。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-8.png)

第四步，导入完成后，就可以点开单表进行查看了。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-9.png)

第五步，当完成重新设计后，就可以选择导出 DDL 到数据库表了。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-10.png)

当然了，也可以直接配置数据库 DB，这样就可以直接连接导入导出了。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-11.png)

导出的 SQL 文件可以直接通过宝塔面板上传到服务器端，然后再直接导入到数据库。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-12.png)

如果需要用到数据库说明文档的话，也可以直接通过导出到 Word 文档来完成。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-13.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-14.png)

数据域是在数据类型的基础上，基于当前项目定义的有一定业务含义的数据类型，比如说我这里维护了一个长度为 90 的名称数据域。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-15.png)

当我需要把某个数据字段的数据域设置成「名称」的时候，长度就会自动填充为 90，不需要手动再去设置。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-16.png)

### **03、维护数据表**

第一步，选中数据表，右键选择「新增数据表」

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-17.png)

第二步，填写数据表名

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-18.png)

点击「确定」后，chiner 会帮我们自动生成一些常见常用的字段，比如说创建人、创建时间、更新人、更新时间等，非常的智能化。通常来说，这些字段都是必须的。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-19.png)

如果这些默认字段不满足需求的时候，还可以点击「设置」新增默认字段，比如说删除标记，一般来说为了安全起见，数据库都会采用非物理删除。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-20.png)

一般来说，我们更习惯字段小写命名，因此可以直接选中一列，然后选择大小写转换。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-21.png)

就变成小写了。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-22.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-23.png)

来看一下整体给出来的关系图，还是非常清爽的。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/chiner-24.png)
