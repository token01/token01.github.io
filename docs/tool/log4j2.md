...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-a9461265-7652-4512-9219-6b3e82392415.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-43f0b03d-5c4a-4af3-9e4c-177956246740.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-4ba440d9-c0b6-4ad2-b538-9d303cc99d90.png)
...
```
for (int i = 1;i < 20; i++) {
    logger.debug("微信搜索「{}」，回复关键字「{}」，有惊喜哦","musk", "java");
}
```

再次运行 Demo 类，可以看到根目录下多了 3 个日志文件：

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-07af98ca-cf94-427e-adb6-bd935e32a8d0.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-32b853ce-8beb-496b-b66f-31b650c257ab.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/tool/log4j2-1b04167d-a11f-4447-9062-cb3cdd59aa73.png)
