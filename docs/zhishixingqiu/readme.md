...
tag:
  - 知识星球
description: 沉默王二的编程知识星球-架构师进阶之路-第二次介绍，这是一个 Java 学习指南 + 编程实战的私密圈子，你可以向二哥提问、帮你制定学习计划、跟着二哥一起做实战项目，冲冲冲。
head:
  - - meta
    - name: keywords
...
今天爬上来宣传一下我的编程星球- 架构师进阶之路。毕竟上次宣传还是在 [3 个月前](https://mp.weixin.qq.com/s/fpQZq4vOA-bH5XCZETcXLA)（2022-08-07），3 个月时间，星球发生的变化也比较大，是时候给大家通报一声了。
...
目前已经有 1000 多名球友加入了，讲良心话，这个发展速度远远超出了二哥的预期，因为我后来加补的 500 张 30 元优惠券也所剩不多了。

所以想要加入的小伙伴这次一定要抓紧了（文末有优惠券，不要再犹豫了）。

知识星球上显示已经运营了 255 天，其实满打满算，二哥的编程星球正式上线的时间只有 6 个月时间，所以二哥在这里还是要感谢一下各位球友的大力支持和信任。

那在正式上线前，二哥已经默默筹备了 2 个多月时间，紧锣密鼓地撰写了星球专属的三个专栏：《**Java 面试指南**》、《**编程喵实战项目笔记**》（SpringBoot+Vue 的前后端分离项目，附源码）、《**二哥的 LeetCode 刷题笔记**》（Java版本）。

在正式运营的这六个月时间里，我又补充了不少章节，目前三个专栏也越来越完整和饱满了。给大家看一下一屏截图能装得下的目录结构。
...
于是在好朋友 Guide 哥的再三督促下，二哥就在知识星球上创建了《**架构师进阶之路**》这个编程学习圈子，门槛定的很实在，这样不仅能把所有的问题都沉淀下来，也方便需要一起学习的小伙伴互相交流和切磋技艺。
...
目前已经有 1000+ 人加入星球，随着加入的人数增加，这个定价还会继续调整，越早加入越划算！
